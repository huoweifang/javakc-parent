...
public class DispOrdController {
    ...
    @ApiOperation("查询所有调度指令库数据")//指定的是swagger方法中对应的内容
    @GetMapping
    ...
    public APICODE findPageDispOrd(DispOrdQuery dispOrdQuery,
        ...
        Page<DispOrd> page = dispOrdService.findPageDispOrd(dispOrdQuery,
                pageNum,pageSize);
        //当前页的数据集合
    ...
    public APICODE getDispOrdById(@PathVariable("dispOrdId") int dispOrdId){
